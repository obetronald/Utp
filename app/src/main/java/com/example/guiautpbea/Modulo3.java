...
public class Modulo3 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uni.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1 = new Intent(Modulo3.this,Universidad.class);
                Modulo3.this.startActivity(int1);
            }
        });
        aul.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int2 = new Intent(Modulo3.this,Aulas.class);
                Modulo3.this.startActivity(int2);
            }
        });
        labo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int3 = new Intent(Modulo3.this,Laboratorios.class);
                Modulo3.this.startActivity(int3);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.modulo3, menu);
        return true;
    }
